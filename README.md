...
one-factor-per-slot architecture. Its first six sealed batches are valid
...
collapsed the code to 169–231 messages. Normalized minimax factor training also
failed to recover color or shape. The ECP-6 positive controls remained perfect.
The ECP-7 confirmatory test remains sealed. See
