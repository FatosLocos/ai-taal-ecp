...
one-factor-per-slot architecture. Its first seventeen sealed batches are valid
...
still regressed to 77.09% validation. The ECP-6 positive controls remain perfect
and the ECP-7 confirmatory test remains sealed. See
